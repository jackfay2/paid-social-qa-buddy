...
COMMON_ENV="QA_SERVICE_ROLE=worker,GCP_PROJECT_ID=${PROJECT},BQ_META_PROJECT=polaris-data-317717,QA_RUN_STORE_BACKEND=firestore,QA_FIRESTORE_COLLECTION_NAME=qa_runs,QA_SHEETS_AUTH_MODE=adc,QA_GEMINI_MODEL=gemini-2.0-flash,QA_WORKER_MAX_RUNTIME_SECONDS=720,QA_CLOUD_TASKS_SERVICE_ACCOUNT_EMAIL=${SA}"
