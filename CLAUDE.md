...
Per Kerri (2026-06-03): Peacock is a first-class **mode**, triggered explicitly, with Peacock-specific vocabulary. Live on worker rev **`00022-nlh`** (Phase A + Phase B + Lever 1 + parser fix + URL domain-mode; history: `00018-mzt` A, `00019-6x2` B, `00020-gvf` Lever 1, `00021-qnq` parser fix), verified end-to-end (`/readyz` 200).
