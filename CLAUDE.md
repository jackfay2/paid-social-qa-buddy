...
Per Kerri (2026-06-03): Peacock is a first-class **mode**, triggered explicitly, with Peacock-specific vocabulary. Live on worker rev **`00024-7rn`** (Phase A + Phase B + Lever 1 + parser fix + URL domain-mode + Review enrichment + deterministic spelling; recent history: `00021-qnq` parser fix, `00022-nlh` URL domain-mode, `00023-4np` enrichment), verified end-to-end (`/readyz` 200).
