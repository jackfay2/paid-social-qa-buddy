...
Per Kerri (2026-06-03): Peacock is a first-class **mode**, triggered explicitly, with Peacock-specific vocabulary. Live on worker rev **`00023-4np`** (Phase A + Phase B + Lever 1 + parser fix + URL domain-mode + Review enrichment; history: `00018-mzt` A, `00019-6x2` B, `00020-gvf` Lever 1, `00021-qnq` parser fix, `00022-nlh` URL domain-mode), verified end-to-end (`/readyz` 200).
