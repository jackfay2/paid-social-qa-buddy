...
Per Kerri (2026-06-03): Peacock is a first-class **mode**, triggered explicitly, with Peacock-specific vocabulary. All live on worker rev `00018-mzt`, verified end-to-end. Demo sheets: standard `1ORSm…` (IBD), Peacock `1KWk…`.
