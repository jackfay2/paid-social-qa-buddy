...
Per Kerri (2026-06-03): Peacock is a first-class **mode**, triggered explicitly, with Peacock-specific vocabulary. Live on worker rev **`00020-gvf`** (Phase A + Phase B + Lever 1; history: `00018-mzt` A, `00019-6x2` B), verified end-to-end (`/readyz` 200). Demo sheets: standard `1ORSm…` (IBD), Peacock `1KWk…`.
