...
Per Kerri (2026-06-03): Peacock is a first-class **mode**, triggered explicitly, with Peacock-specific vocabulary. Live on worker rev **`00019-6x2`** (Phase A + Phase B v1; was `00018-mzt` for A-only), verified end-to-end (`/readyz` 200). Demo sheets: standard `1ORSm…` (IBD), Peacock `1KWk…`.
